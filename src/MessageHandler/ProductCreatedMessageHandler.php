...
{
    public function __construct(private readonly MessageBusInterface $messageBus, private LoggerInterface $apiLogger,)
    {
    }
    ...
    public function __invoke(ProductCreatedMessage $message): void
    {
        ...
        try {
            $this->messageBus->dispatch(SendEmailMessage::create('x', 'xx', 'test', 'test', 'sdsdsd'));
